...
export const spacing = { xs: 4, sm: 8, md: 16, lg: 24, xl: 32, xxl: 48, gutter: 16, borderFocus: 2 };
export const radius = { sm: 8, md: 12, lg: 16, xl: 24, pill: 999 };
export const duration = { fast: 120, base: 200, slow: 320, debounce: 250, splash: 1000, reducedCrossfade: 150 };
// Minimum touch target (PDD §5 global rule): 44 (iOS) / 48 (Android).
export const minTouchTarget = { ios: 44, android: 48 };
