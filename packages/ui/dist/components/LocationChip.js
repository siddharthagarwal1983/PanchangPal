...
export function LocationChip({ city, testID }) {
    const { theme } = useTheme();
    return (_jsx(View, { accessibilityLabel: `Location, ${city}`, testID: testID, style: {
            flexDirection: 'row',
            alignItems: 'center',
        ...
        }, children: _jsxs(Text, { variant: "labelSmall", color: "secondary", children: ["\u25CD ", city] }) }));
}
