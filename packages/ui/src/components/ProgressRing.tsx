...
export function ProgressRing({ current, total, label, testID }: ProgressRingProps) {
  ...
  return <View testID={testID} accessibilityRole="progressbar" accessibilityLabel={label} accessibilityValue={{ min: 1, max: total, now: current, text: label }} style={{ borderRadius: theme.radius.pill, borderWidth: theme.spacing.borderFocus, borderColor: theme.colors.brand.primary, paddingHorizontal: theme.spacing.md, paddingVertical: theme.spacing.sm, alignSelf: 'flex-start' }}>
