...
create index idx_analytics_event_id_ts on analytics_event(event_id, ts);
create index idx_analytics_event_household_ts on analytics_event(household_id, ts); -- North Star rollup
...
create index idx_job_status_runat on job(status, run_at);
