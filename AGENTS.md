# AGENTS.md — Global Engineering Instructions for PanchangPal

Version: 2.0.0

Purpose:
This document defines how Codex should work within the PanchangPal repository.
...
Codex should use this document as an operating manual.
